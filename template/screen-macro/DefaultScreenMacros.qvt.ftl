...
<#else><#-- server rendered, non-static -->
    ...
    <#if !skipStart>
        ...
        <div class="q-my-sm q-table__container q-table__card q-table--horizontal-separator q-table--dense q-table--flat" :class="{'q-table--dark':$q.dark.isActive, 'q-table__card--dark':$q.dark.isActive, 'q-dark':$q.dark.isActive,}" style="overflow: hidden">
